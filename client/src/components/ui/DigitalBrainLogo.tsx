...
// Digital Brain Logo with normal YashAI text
const DigitalBrainLogo: React.FC<LogoProps> = ({ className = "" }) => {
  return (
    ...
    >
      ...
      {/* Digital Nodes - Larger central node */}
      ...
      <defs>
        ...
        <linearGradient id="gold-gradient" x1="40" y1="24" x2="140" y2="24" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FFC107" />
          <stop offset="0.5" stopColor="#FFD700" />
          <stop offset="1" stopColor="#F59E0B" />
        </linearGradient>
